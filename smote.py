...
x_gen = TSNE(n_components=2, random_state=42, verbose=1, angle=0.2, perplexity=100).fit_transform(X_train_SMOTE_sel)

print(trustworthiness(X_real, X_embedded, n_neighbors=5))
